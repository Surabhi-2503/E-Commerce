...
<div style=
  ...
  flex-wrap: wrap;">
         <?php
        $sql="select * from category,product,description where cat_id=cid and pro_id=pro_id1 and cat_name='earrings'";
        ...
        if($res->num_rows>0)
                 {
                    while($row = $res->fetch_assoc()) 
                    {
                        ...
                        $pcolor= $row['color']; 
                        $pid=$row['pro_id'];
                        echo "<div style=\" padding:3%;flex-grow:1;flex-basis:10%;flex: 1 20%;\">";
                        ...
                        echo "<p style=\"margin-top:12px;\"><b>COLOR:</b><font color=\"red\"> $pcolor</font><br><b>BRAND:</b> <font color=\"red\">$pname</font><br><b>PRICE:</b><font color=\"red\"> $pprice</font></p><br>";
