...
<div style="
 ...
 <h3>PAYMENT</h3><br>
    ...
    <form method="post" action="paymentcod.php" >
        ...
        <br> TOTAL PRICE:<br><input type="number" name="tprice" value="<?php echo $sum; ?>" disabled style="width:200px;
                    ...
                    -o-border-radius:5px;
                    -moz-border-radius:5px;"><br>
        <br> MODE:<br><input type="text" name="tprice" value="<?php echo $MODE; ?>" disabled style="width:200px;
                    height: 30px;
                    border: 0;
                    border-radius:7px;
                    padding-left:7px;
        ...
        <br>ADDRESS:<br><textarea rows="10" cols="35" name="addre" placeholder="address" required  style="width:200px;
                ...
                -moz-border-radius:5px;"></textarea><br>
                 <div class="aaa">
        <br><input type="submit" value="make payment" name="next2">
                 </div>
    </form>
