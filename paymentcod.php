   ...
   $arraycart=array();
    ...
    $carts="";
      $sql="select * from cart where userid1='$id1'";
                ...
                $sql="insert into payment(uid1,pro_id3,car_id,total_price,mode_of_payment,tot_qua,delivary_date,address) values ('$id1','$prods','$carts','$sum','$MODE','$totqua','$NewDate','$addres')";
